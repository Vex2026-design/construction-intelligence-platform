...
create table if not exists projects (
  ...
  status text default 'NO APPROVED DATA',
  cod_target date,
  created_at timestamp with time zone default now()
);
...
insert into projects(code,name,technology,mw_dc,mw_ac,planned,forecast,status,cod_target) values
('V0015','Atzori','Tracker 2P',5.51,4.9,.797,.380,'NO APPROVED DATA','2026-09-14'),
('V0021','Friargiu','Tracker 2P',5.59,4.5,.724,.383,'NO APPROVED DATA','2026-09-20'),
('V0012','Loffreda','Tracker 1P',5.999,5.5,.360,.360,'NO APPROVED DATA','2026-10-02'),
('V0057','Bertolin','Tracker 1P',11.818,10.8,.673,.069,'NO APPROVED DATA','2026-09-30')
on conflict(code) do nothing;

insert into issues(project_code,title,owner,impact,status) values
('V0015','In attesa primo Weekly approvato','IPP','Info','Open'),
('V0021','In attesa primo Weekly approvato','IPP','Info','Open')
